...
namespace Lazar_Sorin_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Lazar_Sorin_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Lazar_Sorin_Lab8Context context,
